...
export class GenreComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.genreService
      ...
      .subscribe(
        (res: HttpResponse<IGenre[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInGenres(): void {
    this.eventSubscriber = this.eventManager.subscribe('genreListModification', () => this.loadPage());
  }
