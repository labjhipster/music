...
export class TrackComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.trackService
      ...
      .subscribe(
        (res: HttpResponse<ITrack[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTracks(): void {
    this.eventSubscriber = this.eventManager.subscribe('trackListModification', () => this.loadPage());
  }
