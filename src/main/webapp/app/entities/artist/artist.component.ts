...
export class ArtistComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.artistService
      ...
      .subscribe(
        (res: HttpResponse<IArtist[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInArtists(): void {
    this.eventSubscriber = this.eventManager.subscribe('artistListModification', () => this.loadPage());
  }
